...
# PLOT ESTIMATE OPTIMIZATION ON VS OFF along y-axis
...
# PLOT ESTIMATE OPTIMIZATION ON VS OFF along x-axis
plt.subplot(2,1,1)
...
plt.legend(['formation reference path','target path','AUV1 path','AUV2 path','LOCATION TO DEFEND',
