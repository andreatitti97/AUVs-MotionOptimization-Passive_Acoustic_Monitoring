...
spec = importlib.util.spec_from_file_location("module.ekf", "/home/andrea/ros_simulation_ws/src/ipp_pkg/src/Classes/ekf.py")
ekf = importlib.util.module_from_spec(spec)
spec.loader.exec_module(ekf)
...
class Tracker:
    ...
    def __init__(self, id, init_cov):
        ...
        self.id  = id
        self.__ekf = ekf.ExtendedKalmanFilter(init_cov)
